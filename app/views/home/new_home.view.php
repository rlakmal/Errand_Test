        ...
        <div class="row">
          ...
          <div class="col-md-6 col">
            <div class="detail-box">
              <!-- <div style="font-size: 70px; font-weight:600;">එRRAND
              </div> -->
              ...
              <div class="button-container">
                <a href="<?= ROOT ?>/home/signinverify"> Register as Customer </a>
...
\
  ...
  <script>
    function validateForm() {
      ...
      var message = document.querySelector('.message-box').value.trim();
