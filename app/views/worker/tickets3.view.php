...
<body>
    ...
    <!-- Scripts -->
    <!--<script src="--><?php //= ROOT 
                        ?><!--/assets/js/script-bar.js"></script>-->
    ...
    <div class="container">
        ...
        <form>
            <div class="form">
                <input style="margin-bottom: 15px; width: 15%; border-radius: 20px" class="form-group" type="text" placeholder="Search..." id="searchInput">
    ...
    <!-- raise new ticket -->
    <div style="width: 30%" class="popup-report">
        <h2>Raise New Ticket</h2>
        <form method="POST">
            <h4>Title : </h4>
            <input style="width: 75%" name="title" type="text" placeholder="Enter Ticket Title" required>
            <h4>Description : </h4>
            <input style="width: 75%" name="description" type="text" placeholder="Enter Ticket Description" required>
            <div class="btns">
    ...
    <div class="popup-v" id="edit">
        ...
        <form action="<?= ROOT ?>/worker/tickets" method="POST">
            <h4>Title : </h4>
            <input id="t_title" style="margin-top: 10px" name="title" type="text" placeholder="Enter Ticket Title" required>
            <h4>Body : </h4>
            <input id="t_title" style="margin-top: 10px" name="description" type="text" placeholder="Enter Ticket Body" required>
