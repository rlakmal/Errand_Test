...
<!-- content  -->
<div   style="width: 85%; position: absolute; top: 8%; right: 0; margin-right: 0">
...
<div style="width: 30%" class="popup-report">
    ...
    <form method="POST">
        <h4>Title : </h4>
        <input style="width: 25%" name="title" type="text" placeholder="Enter Ticket Title" required>
        <h4>Description : </h4>
        <input style="width: 25%" name="description" type="text" placeholder="Enter Ticket Description" required>
        <div class="btns">
