...
<!---->
    ...
    <div class="profile-container3">
        ...
        <div class="container-left">
            ...
            <a style="top:0; position: relative; margin: 20px" href="<?= ROOT ?>/member/workers"><button style="top:0; position: relative; margin: 20px" class="close-button">Close</button></a><br>
            <button class="ground-<?php echo $data['newData']['verified'] ?  "unarchive" : "archive";?>" onclick="showConfirmationPopup(<?= $data['newData']['work_id'] ?>)"><?php echo $data['newData']['verified'] ?  "Unverify" : "Verify";?></button>
...
<script>
    ...
    function showConfirmationPopup(id) {
        ...
        form.action = `<?= ROOT ?>/member/verification2?id=${id}`;
...
<script>
    ...
    function load_rating_data() {
        ...
        console.log(id);
        $.ajax({
            url: "<?= ROOT ?>/member/fetchworkerratingsreviews",
            method: "POST",
            data: {
                id: id,
