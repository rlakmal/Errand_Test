...
<head>
    ...
    <style>
        ...
        .search-input {
            width: 50%;
            padding: 10px 30px 10px 10px; /* Adjusted padding to accommodate icon */
            border: 1px solid #ccc;
            border-radius: 20px; /* Adjusted border-radius for a rounded search bar */
            font-size: 16px;
            outline: none;
            background-image: url('search-icon.png'); /* Add your search icon image here */
            background-size: 20px; /* Adjusted size of the search icon */
            background-repeat: no-repeat;
            background-position: calc(100% - 10px) center; /* Adjusted position of the search icon */
        }
